...
public class StorageFiltersData : GameComponent
{
    ...
    private static readonly Dictionary<int, string> ZoneCurrentKey = new();
    private static readonly Dictionary<int, int> ZoneCurrentDepth = new();

    private static readonly Dictionary<int, string> BuildingCurrentKey = new();
    private static readonly Dictionary<int, int> BuildingCurrentDepth = new();

    private static readonly Dictionary<IStoreSettingsParent, string> CurrentKey = new();
    private static readonly Dictionary<IStoreSettingsParent, int> CurrentDepth = new();
